...
// Ouvrir "Mes commandes" => notifs de changement de statut lues (baisse le total de la cloche)
markNotificationsRead($pdo, $userId, ["ORDER_UPDATE", "ORDER_DELIVERED", "ORDER_STATUS"]);
