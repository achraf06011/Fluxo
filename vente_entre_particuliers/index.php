...
<div class="container my-4">
  ...
  <?php if (count($recentlyViewed) > 0 && !$isFiltering && $page === 1): ?>
    <div class="mt-4 mb-3">
  ...
  <?php if (isLoggedIn() && count($recommendedItems) > 0  && !$isFiltering && $page === 1): ?>
    <div class="mt-4 mb-3">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        <div>
  ...
  <img src="<?php echo e(imgUrl($a)); ?>" class="card-img-top" alt="">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-2 small text-muted card-mode">
                    Mode: <b><?php echo e(modeLabel($modeV)); ?></b>
                  </div>
                </div>
              </div>
...
<nav class="mt-4">
  <ul class="pagination justify-content-center flex-wrap">
    ...
    <?php
      $window = 2; // nombre de pages affichées de chaque côté de la page courante
