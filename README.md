...
- **Messagerie web** : temps réel via _polling_ (3 s), pas de WebSocket — choix adapté à un hébergement PHP/WAMP classique.
- **Notifications mobile** : notifications **locales** (Expo Go). Le vrai _push serveur_ nécessiterait un _development build_.
...
_Projet réalisé dans le cadre d'un PFE — marketplace web & mobile « Fluxo »._
