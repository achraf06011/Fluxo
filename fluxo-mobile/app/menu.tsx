    ...
    <View style={styles.overlay}>
      ...
      <View style={styles.panel}>
        ...
        <TouchableOpacity
          style={styles.item}
          onPress={() => {
            if (isLoggedIn) markCategoryRead("commandes");
            goToProtected("/mes-commandes");
          }}
        >
          <View style={styles.itemRow}>
            <Text style={styles.itemText}>Mes commandes</Text>

            {isLoggedIn && badgeCommandes > 0 ? (
              <View style={styles.badge}>
                <Text style={styles.badgeText}>
                  {badgeCommandes > 99 ? "99+" : badgeCommandes}
                </Text>
              </View>
            ) : null}
          </View>
        ...
        <TouchableOpacity
          style={styles.item}
          onPress={() => {
            if (isLoggedIn) markCategoryRead("ventes");
            goToProtected("/mes-ventes");
          }}
        >
          <View style={styles.itemRow}>
            <Text style={styles.itemText}>Ventes</Text>

            {isLoggedIn && badgeVentes > 0 ? (
              <View style={styles.badge}>
                <Text style={styles.badgeText}>
                  {badgeVentes > 99 ? "99+" : badgeVentes}
                </Text>
              </View>
            ) : null}
          </View>
        ...
        <TouchableOpacity
          style={styles.item}
          onPress={() => {
            if (isLoggedIn) markCategoryRead("messages");
            goToProtected("/messages");
          }}
        >
          <View style={styles.itemRow}>
            <Text style={styles.itemText}>Messages</Text>

            {isLoggedIn && badgeMessages > 0 ? (
              <View style={styles.badge}>
                <Text style={styles.badgeText}>
