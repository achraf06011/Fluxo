...
export default function DashboardScreen() {
  ...
  const maxTop = Math.max(...topAnnonces.map((t) => Number(t.montant || 0)), 1);
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>{stats.total_vues}</Text>
          </View>

          <View style={styles.statCard}>
            <Text style={styles.statLabel}>Note moyenne</Text>
            <Text style={styles.statValue}>
              {stats.nb_avis > 0 ? `★ ${stats.note_moyenne}` : "—"}
            </Text>
          ...
          <View style={styles.statCard}>
            <Text style={styles.statLabel}>Favoris reçus</Text>
            <Text style={styles.statValue}>{stats.favoris_recus}</Text>
          </View>

          <View style={styles.statCard}>
            <Text style={styles.statLabel}>Annonces actives</Text>
            <Text style={styles.statValue}>{stats.annonces_actives}</Text>
          </View>
        </View>
                  ...
                  <View style={styles.barTrack}>
                    <View
                      style={[
                        ...
                        {
                          width: `${Math.max(
                            (Number(item.montant || 0) / maxTop) * 100,
                            4
                          )}%`,
                        },
                      ]}
